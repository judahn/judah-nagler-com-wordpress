...
$j(document).ready(function() {
	...
	function ieGrayscaleFix() {
		var tgtThumb  = $j('.thumbnail img');
		var tgtSocial = $j('#social-nav img');

		function setGrayscale(_tgt) {
			var el = $j(this);
			console.log("el: ", el);
			...
			el.css({"width":this.width,"height":this.height});
			if($j.browser.msie){
		...
		// clone image
		tgtThumb.each(function(){  setGrayscale(this); });
		tgtSocial.each(function(){ setGrayscale(this); });	
	}
